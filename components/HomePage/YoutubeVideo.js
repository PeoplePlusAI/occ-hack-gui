...
export default function YoutubeVideo({  }) {
    ...
    return (
        <Box as="section" py={[8, 12]} bg="black" display="flex" alignItems="center" alignSelf='center'>
      <VStack spacing={[6, 12]} width="full">
        <Heading as="h2" size="xl" textAlign="center" color="grey" alignItems="center" fontSize={['2xl', '3xl', '4xl']}>
